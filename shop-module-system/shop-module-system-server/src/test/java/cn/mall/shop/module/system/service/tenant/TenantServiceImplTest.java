package cn.mall.shop.module.system.service.tenant;

import cn.mall.shop.framework.common.enums.CommonStatusEnum;
import cn.mall.shop.framework.common.pojo.PageResult;
import cn.mall.shop.framework.tenant.config.TenantProperties;
import cn.mall.shop.framework.tenant.core.context.TenantContextHolder;
import cn.mall.shop.framework.test.core.ut.BaseDbUnitTest;
import cn.mall.shop.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.mall.shop.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.mall.shop.module.system.dal.dataobject.permission.MenuDO;
import cn.mall.shop.module.system.dal.dataobject.permission.RoleDO;
import cn.mall.shop.module.system.dal.dataobject.tenant.TenantDO;
import cn.mall.shop.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.mall.shop.module.system.dal.mysql.tenant.TenantMapper;
import cn.mall.shop.module.system.enums.permission.RoleCodeEnum;
import cn.mall.shop.module.system.enums.permission.RoleTypeEnum;
import cn.mall.shop.module.system.service.permission.MenuService;
import cn.mall.shop.module.system.service.permission.PermissionService;
import cn.mall.shop.module.system.service.permission.RoleService;
import cn.mall.shop.module.system.service.tenant.handler.TenantInfoHandler;
import cn.mall.shop.module.system.service.tenant.handler.TenantMenuHandler;
import cn.mall.shop.module.system.service.user.AdminUserService;
...
import static cn.mall.shop.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("XX商城", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("XX商城"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("XX商城");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
