package cn.mall.shop.module.system.service.mail;
...
import cn.mall.shop.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.mall.shop.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.mall.shop.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.mall.shop.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.mall.shop.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("XX商城")));
        // 测试 code 不匹配
