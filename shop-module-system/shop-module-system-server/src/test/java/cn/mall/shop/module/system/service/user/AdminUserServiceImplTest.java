package cn.mall.shop.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.mall.shop.framework.common.enums.CommonStatusEnum;
import cn.mall.shop.framework.common.exception.ServiceException;
import cn.mall.shop.framework.common.pojo.CommonResult;
import cn.mall.shop.framework.common.pojo.PageResult;
import cn.mall.shop.framework.common.util.collection.ArrayUtils;
import cn.mall.shop.framework.common.util.collection.CollectionUtils;
import cn.mall.shop.framework.test.core.ut.BaseDbUnitTest;
import cn.mall.shop.module.infra.api.config.ConfigApi;
import cn.mall.shop.module.infra.api.file.FileApi;
import cn.mall.shop.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.mall.shop.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.mall.shop.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.mall.shop.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.mall.shop.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.mall.shop.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.mall.shop.module.system.dal.dataobject.dept.DeptDO;
import cn.mall.shop.module.system.dal.dataobject.dept.PostDO;
import cn.mall.shop.module.system.dal.dataobject.dept.UserPostDO;
import cn.mall.shop.module.system.dal.dataobject.tenant.TenantDO;
import cn.mall.shop.module.system.dal.dataobject.user.AdminUserDO;
import cn.mall.shop.module.system.dal.mysql.dept.UserPostMapper;
import cn.mall.shop.module.system.dal.mysql.user.AdminUserMapper;
import cn.mall.shop.module.system.enums.common.SexEnum;
import cn.mall.shop.module.system.service.dept.DeptService;
import cn.mall.shop.module.system.service.dept.PostService;
import cn.mall.shop.module.system.service.oauth2.OAuth2TokenService;
import cn.mall.shop.module.system.service.permission.PermissionService;
import cn.mall.shop.module.system.service.tenant.TenantService;
...
import static cn.mall.shop.framework.common.util.collection.SetUtils.asSet;
import static cn.mall.shop.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.mall.shop.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.mall.shop.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.mall.shop.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.mall.shop.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.mall.shop.framework.test.core.util.RandomUtils.*;
import static cn.mall.shop.module.system.enums.ErrorCodeConstants.*;
import static cn.mall.shop.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("shopyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("shopyuanma");
        ...
        assertEquals("shopyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("shopyuanma"))).thenReturn("java");
