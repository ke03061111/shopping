package cn.mall.shop.module.system.service.social;
...
import cn.mall.shop.framework.common.util.cache.CacheUtils;
import cn.mall.shop.framework.common.util.http.HttpUtils;
import cn.mall.shop.framework.common.util.object.BeanUtils;
import cn.mall.shop.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.mall.shop.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.mall.shop.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.mall.shop.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.mall.shop.module.system.dal.dataobject.social.SocialClientDO;
import cn.mall.shop.module.system.dal.mysql.social.SocialClientMapper;
import cn.mall.shop.module.system.dal.redis.RedisKeyConstants;
import cn.mall.shop.module.system.enums.social.SocialTypeEnum;
import cn.mall.shop.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.mall.shop.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.mall.shop.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${shop.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${shop.wxa-subscribe-message.miniprogram-state:formal}")
