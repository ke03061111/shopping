package cn.mall.shop.module.infra.service.logger;
...
import cn.mall.shop.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.mall.shop.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.mall.shop.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.mall.shop.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.mall.shop.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.mall.shop.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("shop-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("shop-test");
