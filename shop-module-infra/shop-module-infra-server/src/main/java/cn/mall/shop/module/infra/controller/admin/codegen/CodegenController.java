package cn.mall.shop.module.infra.controller.admin.codegen;
...
import cn.mall.shop.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.mall.shop.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.mall.shop.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.mall.shop.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.mall.shop.module.infra.convert.codegen.CodegenConvert;
...
import cn.mall.shop.module.infra.service.codegen.CodegenService;
...
import static cn.mall.shop.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.mall.shop.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "shop"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "XX商城")
    })
