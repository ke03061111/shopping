package cn.mall.shop.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.mall.shop.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.mall.shop.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "admin，牛逼！")
    @ExcelProperty("结果提示")
