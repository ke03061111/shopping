package cn.mall.shop.module.promotion.service.banner;

import cn.mall.shop.framework.common.pojo.PageResult;
import cn.mall.shop.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import cn.mall.shop.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import cn.mall.shop.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import cn.mall.shop.module.promotion.convert.banner.BannerConvert;
import cn.mall.shop.module.promotion.dal.dataobject.banner.BannerDO;
import cn.mall.shop.module.promotion.dal.mysql.banner.BannerMapper;
...
import static cn.mall.shop.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
