package cn.mall.shop.module.product.controller.app.spu.vo;

import cn.mall.shop.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "XX商城")
    private String name;
