...
import cn.mall.shop.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import cn.mall.shop.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import cn.mall.shop.module.trade.convert.brokerage.BrokerageRecordConvert;
...
import cn.mall.shop.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import cn.mall.shop.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.mall.shop.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static cn.mall.shop.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
