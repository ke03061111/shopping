...
import cn.mall.shop.framework.common.util.string.StrUtils;
import cn.mall.shop.framework.dict.core.DictFrameworkUtils;
import cn.mall.shop.framework.ip.core.utils.AreaUtils;
import cn.mall.shop.module.member.api.address.dto.MemberAddressRespDTO;
import cn.mall.shop.module.member.api.user.dto.MemberUserRespDTO;
import cn.mall.shop.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.mall.shop.module.pay.enums.DictTypeConstants;
import cn.mall.shop.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.mall.shop.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.mall.shop.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.mall.shop.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.mall.shop.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.mall.shop.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.mall.shop.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.mall.shop.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.mall.shop.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.mall.shop.module.trade.controller.admin.order.vo.*;
import cn.mall.shop.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.mall.shop.module.trade.controller.app.order.vo.*;
import cn.mall.shop.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.mall.shop.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.mall.shop.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.mall.shop.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.mall.shop.module.trade.framework.order.config.TradeOrderProperties;
import cn.mall.shop.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.mall.shop.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/shopcode/shop-mall-uniapp/issues/ICY7SJ
