package cn.mall.shop.module.trade.service.brokerage;
...
import cn.mall.shop.module.pay.api.transfer.dto.PayTransferCreateReqDTO;
import cn.mall.shop.module.pay.api.transfer.dto.PayTransferCreateRespDTO;
import cn.mall.shop.module.pay.api.transfer.dto.PayTransferRespDTO;
import cn.mall.shop.module.pay.api.wallet.PayWalletApi;
import cn.mall.shop.module.pay.api.wallet.dto.PayWalletRespDTO;
import cn.mall.shop.module.pay.enums.PayChannelEnum;
import cn.mall.shop.module.pay.enums.transfer.PayTransferStatusEnum;
import cn.mall.shop.module.trade.controller.admin.brokerage.vo.withdraw.BrokerageWithdrawPageReqVO;
import cn.mall.shop.module.trade.controller.app.brokerage.vo.withdraw.AppBrokerageWithdrawCreateReqVO;
import cn.mall.shop.module.trade.dal.dataobject.brokerage.BrokerageWithdrawDO;
import cn.mall.shop.module.trade.dal.dataobject.config.TradeConfigDO;
import cn.mall.shop.module.trade.dal.mysql.brokerage.BrokerageWithdrawMapper;
import cn.mall.shop.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import cn.mall.shop.module.trade.enums.brokerage.BrokerageWithdrawStatusEnum;
import cn.mall.shop.module.trade.enums.brokerage.BrokerageWithdrawTypeEnum;
import cn.mall.shop.module.trade.framework.order.config.TradeOrderProperties;
import cn.mall.shop.module.trade.service.brokerage.bo.BrokerageWithdrawSummaryRespBO;
import cn.mall.shop.module.trade.service.config.TradeConfigService;
...
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.mall.shop.framework.common.util.servlet.ServletUtils.getClientIP;
import static cn.mall.shop.module.pay.enums.ErrorCodeConstants.PAY_TRANSFER_NOT_FOUND;
