package cn.mall.shop.framework.web.config;
...
import cn.mall.shop.framework.web.core.filter.CacheRequestBodyFilter;
import cn.mall.shop.framework.web.core.filter.DemoFilter;
import cn.mall.shop.framework.web.core.handler.GlobalExceptionHandler;
import cn.mall.shop.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ShopWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "shop.demo", havingValue = "true")
