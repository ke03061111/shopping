package cn.mall.shop.framework.jackson.config;

import cn.mall.shop.framework.common.util.json.JsonUtils;
import cn.mall.shop.framework.common.util.json.databind.NumberSerializer;
import cn.mall.shop.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.mall.shop.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ShopJacksonAutoConfiguration {
