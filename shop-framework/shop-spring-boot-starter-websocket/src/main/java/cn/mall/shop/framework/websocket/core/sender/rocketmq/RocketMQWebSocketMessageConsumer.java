package cn.mall.shop.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${shop.websocket.sender-rocketmq.topic}",
        consumerGroup = "${shop.websocket.sender-rocketmq.consumer-group}",
