package cn.mall.shop.framework.tenant.config;

import cn.hutool.extra.spring.SpringUtil;
import cn.mall.shop.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.mall.shop.framework.redis.config.ShopCacheProperties;
import cn.mall.shop.framework.security.core.service.SecurityFrameworkService;
import cn.mall.shop.framework.tenant.core.aop.TenantIgnore;
import cn.mall.shop.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.mall.shop.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.mall.shop.framework.tenant.core.job.TenantJobAspect;
import cn.mall.shop.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.mall.shop.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.mall.shop.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.mall.shop.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.mall.shop.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.mall.shop.framework.tenant.core.service.TenantFrameworkService;
import cn.mall.shop.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.mall.shop.framework.tenant.core.web.TenantContextWebFilter;
import cn.mall.shop.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static cn.mall.shop.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "shop.tenant", value = "enable", matchIfMissing = true) // 允许使用 shop.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class ShopTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/shop-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.mall.shop.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
        ...
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(shopCacheProperties.getRedisScanBatchSize()));
