 ...
 *      1）Spring Async：
 *          {@link cn.mall.shop.framework.quartz.config.ShopAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ShopSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.mall.shop.framework.tenant;
