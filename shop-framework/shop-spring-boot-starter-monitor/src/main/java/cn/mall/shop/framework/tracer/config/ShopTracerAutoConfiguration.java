package cn.mall.shop.framework.tracer.config;

import cn.mall.shop.framework.common.enums.WebFilterOrderEnum;
import cn.mall.shop.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "shop.tracer", value = "enable", matchIfMissing = true)
public class ShopTracerAutoConfiguration {
