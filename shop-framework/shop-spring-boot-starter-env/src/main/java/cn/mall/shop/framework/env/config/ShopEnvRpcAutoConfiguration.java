...
import cn.mall.shop.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import cn.mall.shop.framework.env.core.fegin.EnvRequestInterceptor;
...
public class ShopEnvRpcAutoConfiguration {
