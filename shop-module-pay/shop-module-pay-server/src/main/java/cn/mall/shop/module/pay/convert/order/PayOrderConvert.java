package cn.mall.shop.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.mall.shop.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
