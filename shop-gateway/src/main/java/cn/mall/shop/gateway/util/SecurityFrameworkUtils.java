package cn.mall.shop.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.mall.shop.framework.common.util.json.JsonUtils;
import cn.mall.shop.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from shop-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author admin
 */
@Slf4j
