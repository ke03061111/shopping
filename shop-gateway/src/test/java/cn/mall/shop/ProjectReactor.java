...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.mall.cloud";
    private static final String ARTIFACT_ID = "shop";
    private static final String PACKAGE_NAME = "cn.mall.shop";
    private static final String TITLE = "XX商城管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.mall.cloud";
        String artifactIdNew = "shop";
        String packageNameNew = "cn.mall.shop";
        String titleNew = "XX商城管理系统";
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf("\\")+1) + "mall-cloud"; // 一键改名后，“新”项目所在的目录
