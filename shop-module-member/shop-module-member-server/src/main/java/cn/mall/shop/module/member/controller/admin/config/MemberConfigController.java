package cn.mall.shop.module.member.controller.admin.config;

import cn.mall.shop.framework.common.pojo.CommonResult;
import cn.mall.shop.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.mall.shop.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.mall.shop.module.member.convert.config.MemberConfigConvert;
import cn.mall.shop.module.member.dal.dataobject.config.MemberConfigDO;
import cn.mall.shop.module.member.service.config.MemberConfigService;
